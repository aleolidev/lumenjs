...
async function generatedRuntime(manifest) {
  ...
  return {
    ...
    "playtest-simulation.js": await readFile(
      new URL("./playtest-simulation.js", import.meta.url),
      "utf8"
    ),
    "playtest-browser.js": (
