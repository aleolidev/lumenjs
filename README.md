...
The repository currently contains **First Light** and its focused campaign
slice. It turns an external Tiled map and Lumen-owned gameplay metadata into a
...
interact with Space. Speak to Mira, choose a companion, then walk east to the
trail and complete the encounter. The campaign replay button executes the
recorded deterministic victory route. The visual-mode button switches optional
...
- `public/first-light/campaign-replay.json`: canonical campaign victory replay.
- `public/first-light/campaign-loss-replay.json`: canonical campaign loss replay.
